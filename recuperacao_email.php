...
<body>
    <div class="container-fluid">
		...
		<div id="titulo">Recuperação de Senha</div>
            <p>Digite o e-mail utilizado no cadastro e nós enviaremos a ele um link para redefinição de senha.</p>
			 <form action="#">
            <input type="text" name="email" placeholder="E-mail" style="width:50%"><br>
            <input id="button" type="submit" value="Enviar">
            <input id="button" type="submit" value="Cancelar">
        </form>
